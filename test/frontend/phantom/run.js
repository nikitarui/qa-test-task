...
//Inject mocha and chai
    ...
    page.injectJs("node_modules/phantomjs-polyfill/bind-polyfill.js");

    page.injectJs("public/libs/jquery/dist/jquery.min.js");
    ...
    page.injectJs("test/frontend/mocha/reporter.js");

    //inject your tests
    page.injectJs("test/frontend/mocha/" + testFile);
